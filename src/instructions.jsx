...
export const Instructions = (props) => {
    ...
    const PageFive = () => {
        ...
        return(
            <div style={textStyle}>
                <p>In this study, we will show you 8 different videoclips. Please pay careful attention to what happens in each of them.</p>
                <p>After each videoclip, we will ask you a simple question about the cause of the outcome of the game shown in the clip.</p>
